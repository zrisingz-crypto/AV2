...
void avm_convolve8_vert_dspr2(const uint8_t *src, ptrdiff_t src_stride,
  ...
  if (((const int32_t *)filter_y)[0] == 0) {
    avm_convolve2_vert_dspr2(src, src_stride, dst, dst_stride, filter_x,
    ...
    switch (w) {
      ...
      case 64:
        ...
        break;
      default:
        avm_convolve8_vert_c(src, src_stride, dst, dst_stride, filter_x,
                             x_step_q4, filter_y, y_step_q4, w, h);
        break;
    }
  }
