...
#ifndef AVM_AVM_DSP_MIPS_LOOPFILTER_FILTERS_DSPR2_H_
#define AVM_AVM_DSP_MIPS_LOOPFILTER_FILTERS_DSPR2_H_
...
static INLINE void filter_dspr2(uint32_t mask, uint32_t hev, uint32_t *ps1,
  ...
  int32_t avm_filter_l, avm_filter_r;
  ...
  __asm__ __volatile__(
      /* avm_filter = avm_signed_char_clamp(ps1 - qs1); */
      "subq_s.ph    %[avm_filter_l], %[vps1_l],       %[vqs1_l]       \n\t"
      "subq_s.ph    %[avm_filter_r], %[vps1_r],       %[vqs1_r]       \n\t"
      ...
      /* avm_filter &= hev; */
      "and          %[avm_filter_l], %[avm_filter_l], %[hev_l]        \n\t"
      "and          %[avm_filter_r], %[avm_filter_r], %[hev_r]        \n\t"

      /* avm_filter = avm_signed_char_clamp(avm_filter + 3 * (qs0 - ps0)); */
      "addq_s.ph    %[avm_filter_l], %[avm_filter_l], %[subr_l]       \n\t"
      "addq_s.ph    %[avm_filter_r], %[avm_filter_r], %[subr_r]       \n\t"
      ...
      /* avm_filter &= mask; */
      "and          %[avm_filter_l], %[avm_filter_l], %[mask_l]       \n\t"
      "and          %[avm_filter_r], %[avm_filter_r], %[mask_r]       \n\t"

      : [avm_filter_l] "=&r"(avm_filter_l), [avm_filter_r] "=&r"(avm_filter_r),
  ...
  __asm__ __volatile__(
      /* Filter2 = avm_signed_char_clamp(avm_filter + 3) >>= 3; */
      "addq_s.ph    %[Filter1_l],    %[avm_filter_l], %[t2]           \n\t"
      "addq_s.ph    %[Filter1_r],    %[avm_filter_r], %[t2]           \n\t"

      /* Filter1 = avm_signed_char_clamp(avm_filter + 4) >>= 3; */
      "addq_s.ph    %[Filter2_l],    %[avm_filter_l], %[t1]           \n\t"
      "addq_s.ph    %[Filter2_r],    %[avm_filter_r], %[t1]           \n\t"
      ...
      /* vps0 = avm_signed_char_clamp(ps0 + Filter2); */
      "addq_s.ph    %[vps0_l],       %[vps0_l],       %[Filter2_l]    \n\t"
      "addq_s.ph    %[vps0_r],       %[vps0_r],       %[Filter2_r]    \n\t"

      /* vqs0 = avm_signed_char_clamp(qs0 - Filter1); */
  ...
  __asm__ __volatile__(
      ...
      /* vps1 = avm_signed_char_clamp(ps1 + avm_filter); */
      "addq_s.ph    %[vps1_l],       %[vps1_l],       %[Filter1_l]    \n\t"
      "addq_s.ph    %[vps1_r],       %[vps1_r],       %[Filter1_r]    \n\t"

      /* vqs1 = avm_signed_char_clamp(qs1 - avm_filter); */
...
#endif  // AVM_AVM_DSP_MIPS_LOOPFILTER_FILTERS_DSPR2_H_
