...
uint32_t avm_get4x4sse_cs_msa(const uint8_t *src_ptr, int32_t src_stride,
                              const uint8_t *ref_ptr, int32_t ref_stride) {
  uint32_t err = 0;
  uint32_t src0, src1, src2, src3;
  uint32_t ref0, ref1, ref2, ref3;
...
#define AVM_VARIANCE_WDXHT_MSA(wd, ht)                                         \
  uint32_t avm_variance##wd##x##ht##_msa(                                      \
...
/* clang-format off */
AVM_VARIANCE_WDXHT_MSA(4, 4)
AVM_VARIANCE_WDXHT_MSA(4, 8)

AVM_VARIANCE_WDXHT_MSA(8, 4)
AVM_VARIANCE_WDXHT_MSA(8, 8)
AVM_VARIANCE_WDXHT_MSA(8, 16)

AVM_VARIANCE_WDXHT_MSA(16, 8)
AVM_VARIANCE_WDXHT_MSA(16, 16)
AVM_VARIANCE_WDXHT_MSA(16, 32)

AVM_VARIANCE_WDXHT_MSA(32, 16)
AVM_VARIANCE_WDXHT_MSA(32, 32)
/* clang-format on */

uint32_t avm_variance32x64_msa(const uint8_t *src, int32_t src_stride,
...
uint32_t avm_variance64x32_msa(const uint8_t *src, int32_t src_stride,
                               const uint8_t *ref, int32_t ref_stride,
                               uint32_t *sse) {
  int32_t diff;
...
uint32_t avm_variance64x64_msa(const uint8_t *src, int32_t src_stride,
                               const uint8_t *ref, int32_t ref_stride,
                               uint32_t *sse) {
  int32_t diff;
...
uint32_t avm_mse8x8_msa(const uint8_t *src, int32_t src_stride,
...
uint32_t avm_mse8x16_msa(const uint8_t *src, int32_t src_stride,
                         const uint8_t *ref, int32_t ref_stride,
                         uint32_t *sse) {
...
uint32_t avm_mse16x8_msa(const uint8_t *src, int32_t src_stride,
                         const uint8_t *ref, int32_t ref_stride,
                         uint32_t *sse) {
...
uint32_t avm_mse16x16_msa(const uint8_t *src, int32_t src_stride,
                          const uint8_t *ref, int32_t ref_stride,
                          uint32_t *sse) {
...
void avm_get8x8var_msa(const uint8_t *src, int32_t src_stride,
                       const uint8_t *ref, int32_t ref_stride, uint32_t *sse,
                       int32_t *sum) {
  *sse = sse_diff_8width_msa(src, src_stride, ref, ref_stride, 8, sum);
}

void avm_get16x16var_msa(const uint8_t *src, int32_t src_stride,
                         const uint8_t *ref, int32_t ref_stride, uint32_t *sse,
                         int32_t *sum) {
  *sse = sse_diff_16width_msa(src, src_stride, ref, ref_stride, 16, sum);
}

uint32_t avm_get_mb_ss_msa(const int16_t *src) { return get_mb_ss_msa(src); }
