...
;    short *filter
;)
globalsym(avm_filter_block1d4_v8_sse2)
sym(avm_filter_block1d4_v8_sse2):
    push        rbp
    mov         rbp, rsp
...
;    short *filter
;)
globalsym(avm_filter_block1d8_v8_sse2)
sym(avm_filter_block1d8_v8_sse2):
    push        rbp
    mov         rbp, rsp
    SHADOW_ARGS_TO_STACK 6
    SAVE_XMM 7
...
;    short *filter
;)
globalsym(avm_filter_block1d16_v8_sse2)
sym(avm_filter_block1d16_v8_sse2):
    push        rbp
    mov         rbp, rsp
    SHADOW_ARGS_TO_STACK 6
    SAVE_XMM 7
...
;    short *filter
;)
globalsym(avm_filter_block1d4_h8_sse2)
sym(avm_filter_block1d4_h8_sse2):
    push        rbp
    mov         rbp, rsp
    SHADOW_ARGS_TO_STACK 6
    SAVE_XMM 7
...
;    short *filter
;)
globalsym(avm_filter_block1d8_h8_sse2)
sym(avm_filter_block1d8_h8_sse2):
    push        rbp
    mov         rbp, rsp
    SHADOW_ARGS_TO_STACK 6
    SAVE_XMM 7
...
;    short *filter
;)
globalsym(avm_filter_block1d16_h8_sse2)
sym(avm_filter_block1d16_h8_sse2):
    push        rbp
    mov         rbp, rsp
    SHADOW_ARGS_TO_STACK 6
    SAVE_XMM 7
