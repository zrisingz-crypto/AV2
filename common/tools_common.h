 ...
 */
#ifndef AVM_COMMON_TOOLS_COMMON_H_
#define AVM_COMMON_TOOLS_COMMON_H_
...
void die(const char *fmt, ...) AVM_NO_RETURN;
void fatal(const char *fmt, ...) AVM_NO_RETURN;
void warn(const char *fmt, ...);

void die_codec(avm_codec_ctx_t *ctx, const char *s) AVM_NO_RETURN;

/* The tool including this file must define usage_exit() */
void usage_exit(void) AVM_NO_RETURN;

#undef AVM_NO_RETURN

// The AVM library can support different encoders / decoders. These
...
const char *get_short_name_by_avm_decoder(avm_codec_iface_t *decoder);
// If the interface is unknown, returns 0.
...
#endif  // AVM_COMMON_TOOLS_COMMON_H_
