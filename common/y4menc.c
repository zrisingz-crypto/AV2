...
// image format.
const char *colorspace8(avm_chroma_sample_position_t csp, avm_img_fmt_t fmt) {
  switch (fmt) {
    case AVM_IMG_FMT_I444: return "C444";
    case AVM_IMG_FMT_I422: return "C422";
    default:
      if (csp == AVM_CSP_LEFT) {
        return "C420mpeg2 XYSCSS=420MPEG2";
      } else if (csp == AVM_CSP_TOPLEFT) {
...
static const char *colorspace(unsigned int bit_depth,
  ...
  switch (bit_depth) {
    ...
    case 9:
      return fmt == AVM_IMG_FMT_I44416   ? "C444p9 XYSCSS=444P9"
             : fmt == AVM_IMG_FMT_I42216 ? "C422p9 XYSCSS=422P9"
                                         : "C420p9 XYSCSS=420P9";
    case 10:
      return fmt == AVM_IMG_FMT_I44416   ? "C444p10 XYSCSS=444P10"
             : fmt == AVM_IMG_FMT_I42216 ? "C422p10 XYSCSS=422P10"
                                         : "C420p10 XYSCSS=420P10";
    case 12:
      return fmt == AVM_IMG_FMT_I44416   ? "C444p12 XYSCSS=444P12"
             : fmt == AVM_IMG_FMT_I42216 ? "C422p12 XYSCSS=422P12"
                                         : "C420p12 XYSCSS=420P12";
    case 14:
      return fmt == AVM_IMG_FMT_I44416   ? "C444p14 XYSCSS=444P14"
             : fmt == AVM_IMG_FMT_I42216 ? "C422p14 XYSCSS=422P14"
                                         : "C420p14 XYSCSS=420P14";
    case 16:
      return fmt == AVM_IMG_FMT_I44416   ? "C444p16 XYSCSS=444P16"
             : fmt == AVM_IMG_FMT_I42216 ? "C422p16 XYSCSS=422P16"
