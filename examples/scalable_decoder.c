...
int main(int argc, char **argv) {
  ...
  avm_codec_iface_t *decoder = get_avm_decoder_by_index(0);
  ...
  if (avm_codec_control(&codec, AV2D_SET_OUTPUT_ALL_LAYERS, 1)) {
  ...
  if (avm_codec_peek_stream_info(decoder, tmpbuf, 32, &si)) {
